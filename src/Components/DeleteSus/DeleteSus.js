...
export default function DeleteSus({ addUserSuspension, userSuspension, setSelectedSuspension, selectedSuspension }) {
  ...
  return (
    <section className="delete-part-form-section">
      ...
      <div className="delete-sus-details" >
        ...
        {deleteSusDetails && <h3 className="delete-part">{`${deleteSusDetails.susData.name} 
